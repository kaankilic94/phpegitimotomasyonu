        ...
        <div class="col-md-18">
            <div class="box" id="bx">
                        ...
                        <h1 class="intro-text text-center">
                            Bilgisayar Mühendisliği Misyonu
                        </h1>
                        <hr>

                        <p class="trhcep">

                           <br> Kocaeli Üniversitesi Bilgisayar Mühendisliği Bölümü, üniversite öz görevinden hareketle;
                            evrensel düzeyde eğitim, öğretim, araştırma ve yayın faaliyetlerini sürdürerek tüm insanlığa sosyal,
                            kültürel, bilimsel, ekonomik ve teknolojik alanda hizmet etmeyi, insan haklarına saygılı, hür düşünceli,
                            etik değerlere bağlı, yaratıcı ve yapıcı mühendisler yetiştirmeyi amaç edinmiştir.
                            <br><br>
                        </p>
