...
$vt->query("INSERT INTO test(tid,soru,cevap1,cevap2,cevap3,cevap4,dogru) VALUES ('$j','$dsoru','$dcevapa','$dcevapb','$dcevapc','$dcevapd','$radyo')");

include "testeklevtbasarili.php";
//$sonuc = $vt->query($sql);
