                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
                        <div class="panel panel-default">
                            <div class="panel-heading" id="panel-h"><p>Osman Kurt</p></div>
                            <div class="panel-body">
                                <div class="col-md-4"> <img class="img-responsive" src="" alt=""/> </div>
                                <div class="col-md-4">
                                    <ol class="personelBilgi">
                                        <li><a  class="btn btn-success btn-large">Kişisel Web Sitesi</a></li>

                                        <li><span class="inf">E-posta:osmankurt@gmail.com</li>
