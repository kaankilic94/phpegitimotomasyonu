    ...
    <div class="row">
        <div class="col-md-18">
            <div class="box" id="bx">
                ...
                <h2 class="intro-text text-center trhcep">MATEMATİK SORUSU EKLE</h2>
                <hr>

                <br><br><br>

                <p class="text-success"><span class="glyphicon glyphicon-ok"></span> Soru başarıyla eklendi.</p>

                <form action="testeklevt.php" method="post">
