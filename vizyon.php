        ...
        <div class="col-md-18">
            <div class="box" id="bx">
                ...
                <h1 class="intro-text text-center">
                    Bilgisayar Mühendisliği Vizyonu
                </h1>
                <hr>

                <p class="trhcep">

                    <br>Vizyonumuz, nitelikli akademik kadrosu ile vereceği eğitim-öğretim, üreteceği bilgi ve teknolojiyle
                    kendi kaynaklarını yaratabilen, sanayi ile işbirliği yanında, bölge sorunlarına çözüm bulabilen, analitik
                    düşüncesini yaratıcılığıyla bütünleştiren ve mesleki alanda donanımlı Mühendisler yetiştirerek kendi alanında
                    ülkemizde ve uluslararası düzeyde kabul ve takdir gören bir bölüm olmaktır.
                    <br><br>
