    ...
    <div class="row">
        <div class="col-md-18">
            <div class="box" id="bx">
                ...
                <h2 class="intro-text text-center trhcep">COĞRAFYA VİDEO SİL</h2>
                <hr>
                <p class="text-danger"><span class="glyphicon glyphicon-remove"></span> Lütfen silmek istediğiniz videonun checkbox'ını işaretleyiniz.</p>
                ...
                {
                    $sorg = $baglanma->query("SELECT * FROM sosyalvideos WHERE id");
                    ...
                    while($row = $sorg->fetch_object())
                    {
                        ...
                        <form action="sosyalvideosilvt.php" method="post">
