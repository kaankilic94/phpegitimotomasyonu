    ...
    <div class="row">
        <div class="col-md-18">
            <div class="box" id="bx">
                        ...
                        <p class="trhcep">
                            <br>Günümüzde e-uygulamalardan (e-devlet, e-iş, e-ticaret…) savunma sanayisine, haberleşme ve elektronik
                            teknolojisinden eğitim ve sağlık sektörüne kadar her konuda Bilgisayar Mühendisliği'nin
                            önemi ve etkisi artmaktadır. Sonuç olarak hayatımızın can damarı durumuna gelmiş
                            olan bilgi ve iletişim teknolojilerinin gelişiminde Bilgisayar Mühendisliği önemli rol oynamaktadır.
                            <br> <br>Bilgisayar Mühendisliği Bölümü Lisans Programı, öğrenciye modern bilişim teknolojilerinin temel
                            kuramsal kavramlarını ve ilkelerini teorik eğitimin yanında yoğun pratik uygulamalarla destekli bir şekilde
                            vermektedir. Bölümün başlıca amaçları, Bilgisayar Mühendisliği alanındaki bilimsel, endüstriyel ve teknolojik
                            gelişmeleri takip ederek öğrencilerini ileri araştırmalara yöneltmek ve bu gelişmelere katkıda bulunarak daha
                            ileri noktalara gitmesini sağlamaktır.
                            <br> <br>Temel araştırma konularımız; yapay zeka, algoritmalar, veritabanları, yazılım mühendisliği, işletim sistemleri,
                            network ve dağıtık sistemler olarak özetlenebilir. Ancak bunun yanında, gelişen teknolojiye uygun olarak seçimlik olarak
                            açılan derslerle öğrencilere ilgi alanlarına uygun olarak zengin çeşitlilikte bilgi edinme imkanları sunulmaktadır.
                            <br> <br>Bölümümüzden mezun olan öğrencilerimiz bilgisayar sektörünün önde gelen araştırma birimlerinde (Ar-Ge) ve şirketlerinde
                            önemli yerlerde bulunmaktadırlar.
                            <br> <br>
                        </p>

                        <p>
                            <strong>Bölümün Öğretim Üyesi Sayısı:</strong>24
                        </p>
                        ...
                        <ul>
                            ...
                            <li>10 Araştırma Görevlisi </li>
                            <li>1 Uzman</li>
                        </ul>

                        <p>
                            <strong>Bölümün İdari Personel Sayısı:</strong>1
                        </p>


                        <p>
                            <strong>Bölümün Öğrenci Sayısı:</strong>1316
                        </p>

                        <ul>
                            <li>Doktora Öğrenci Sayısı:31</li>
                            <li>Yüksek Lisans Öğrenci Sayısı:66</li>
                            <li>I.Öğretim(Örgün) Lisans Öğrenci Sayısı:641</li>
                            <li>II.Öğretim(Gece) Lisans Öğrenci Sayısı:578</li>
                        </ul>
            </div>
        </div>
    </div>
