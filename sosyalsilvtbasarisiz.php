    ...
    <div class="row">
        <div class="col-md-18">
            <div class="box" id="bx">
                ...
                <h2 class="intro-text text-center trhcep">COĞRAFYA SORUSU SİL</h2>
                <hr>

                <br><br><br>
                <p class="text-danger"><span class="glyphicon glyphicon-remove"></span> Lütfen silmek istediğiniz sorunun checkbox'ını işaretleyiniz.</p>
                ...
                {
                    $sorg = $baglanma->query("SELECT * FROM sosyal WHERE tid");
                    ...
                    while($row = $sorg->fetch_object())
                    {
                        ...
                        <form action="sosyalsilvt.php" method="post">
                            <div class="form-group">
                                Soru:<br>
                                <input type="text" class="form-control" value="<?php echo $row->soru; ?>" name="soru" /><br/>
                            </div>

                            <div class="form-group">
                                <label><input type="checkbox" value="<?php echo $row->tid; ?>" name="tid">Sorunun silinmesi icin kutucuğu işaretleyiniz.</label>
                            </div>
