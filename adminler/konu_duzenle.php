    ...
    if($_POST){
        ...
        if(!$baslik ||  !$aciklama){
            ...
            if($update){
                ...
                header("refresh: 2; url=/kou/adminler/?do=konular");
            }else{
       ...
       ?>
        ...
        <form action="" method="post">
            ...
            <div style="margin: 28px;" class="form-group">
                ...
                <div  class="breadcrumb"><?php echo $m["konu_aciklama"];?></div>
                ...
                <textarea style="height: 500px" name="aciklama" class="form-control" rows="5" id="comment"><?php echo $m["konu_aciklama"];?></textarea><br/>
                ...
                <li style="list-style-type: none;">
                    <select  name="kategori" style="width: 150px ; margin-bottom: 5px;">
                        ...
                        foreach ($x as $t){
                            ...
                            echo '<option value="'.$t["kategori_id"].'"';

                            echo $m["konu_kategori"] == $t["kategori_id"] ? 'selected' : null;
                            echo '>'.$t["kategori_adi"].'</option>';
