...
$u=$db->prepare("select * from uyeler where uye_rutbe=?");
$u->execute(array(0));
$u->fetchAll(PDO::FETCH_ASSOC);
$uye=$u->rowCount();

$uonay=$db->prepare("select * from uyeler where uye_onay=? and uye_rutbe=?");
$uonay->execute(array(0,0));
    ...
    <div style="margin: 15px; color: #00aced; " class="breadcrumb">
        ...
        <div style="float: left;" class="col-xl-3 col-sm-6 mb-3">
            <div class="card card-inverse card-success o-hidden h-100">
                ...
                <a href="../adminler/?do=uyeler" class="card-footer clearfix small z-1">
        ...
        <div style="float: left;" class="col-xl-3 col-sm-6 mb-3">
            <div class="card card-inverse card-success o-hidden h-100">
                ...
                <a href="../adminler/?do=kategoriler" class="card-footer clearfix small z-1">
        ...
        <div style="float: left;" class="col-xl-3 col-sm-6 mb-3">
            <div class="card card-inverse card-success o-hidden h-100">
                ...
                <a href="../adminler/?do=konular" class="card-footer clearfix small z-1">
        ...
        <div style="float: left;" class="col-xl-3 col-sm-6 mb-3">
            <div class="card card-inverse card-success o-hidden h-100">
                ...
                <a href="../adminler/?do=yorumlar" class="card-footer clearfix small z-1">
