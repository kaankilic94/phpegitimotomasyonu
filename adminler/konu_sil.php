<div class="content-wrapper py-3">
    ...
    if (@$_POST["sil"]){
        ...
        if($toplu){
            ...
            header("refresh:2; url=../adminler/?do=konular");
        }else{
            echo "<div style=\"margin: 15px; \" class=\"breadcrumb\">Konular silinmedi lütfen tekrardan deneyin</div>";
            header("refresh:2; url=../adminler/?do=konular");
        }
    }else{
        echo "<div style=\"margin: 15px; \" class=\"breadcrumb\">Konu silmek için lütfen silmek istediğiniz yorumun kutucuğunu işaretleyin</div>";
        header("refresh:2; url=../adminler/?do=konular");
    }
    ?>
</div>