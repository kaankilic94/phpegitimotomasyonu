    ...
    <div class="row">
        <div class="col-md-18">
            <div class="box" id="bx">
                ...
                <h2 class="intro-text text-center trhcep">FEN BİLİMLERİ VİDEO SİL</h2>
                <hr>
                ...
                {
                    $sorg = $baglanma->query("SELECT * FROM fenvideos WHERE id");
                    ...
                    while($row = $sorg->fetch_object())
                    {
                        ...
                        <form action="fenvideosilvt.php" method="post">
