    ...
    <div class="row">
        <div class="col-md-18">
            <div class="box" id="bx">
                ...
                <h2 class="intro-text text-center trhcep">COĞRAFYA SORULARI</h2>
                <hr>

                <br><br><br>
                <p class="text-success"><span class="glyphicon glyphicon-ok"></span>DOGRU CEVAP</p>
                ...
                else
                {
                    ...
                    {
                        ?>
                        <form action="sosyalkontrol.php" method="post">
