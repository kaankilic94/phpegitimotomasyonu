    ...
    <div class="row">
        <div class="col-md-18">
            <div class="box" id="bx">
                ...
                <h2 class="intro-text text-center trhcep">ÖĞRENCİ EKLEME PANELİ</h2>
                <hr>

                <br><br><br>

                <p class="text-success"><span class="glyphicon glyphicon-ok"></span> Öğrenci veri tabanına başarıyla kayıt edildi.</p>

                <form action="ogrencieklevt.php" method="post">

                    Mail: <br/>
                    <input type="text" class="form-control" name="mail" /><br/>
                    Şifre: <br/>
                    <input type="text" class="form-control" name="passw" /><br/>
                    Ad: <br/>
