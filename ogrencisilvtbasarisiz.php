    ...
    <div class="row">
        <div class="col-md-18">
            <div class="box" id="bx">
                ...
                <hr>
                <p class="text-danger"><span class="glyphicon glyphicon-remove"></span> Lütfen silmek istediğiniz öğrencinin checkbox'ını işaretleyiniz.</p>
                ...
                else
                {
                    ...
                    while($row = $sorg->fetch_object())
                    {
                        ...
                        <form action="ogrencisilvt.php" method="post">
                            <div class="form-group">
                                Mail:<br>
                                <input type="text" class="form-control" value="<?php echo $row->username; ?>" name="mail" /><br/>
                            </div>

                            <div class="form-group">
                                <label><input type="checkbox" value="<?php echo $row->id; ?>" name="id">Silmek için kutucuğu işaretleyiniz.</label>
                            </div>
