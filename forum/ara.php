...
kategoriler.kategori_id=konular.konu_kategori inner join uyeler on uyeler.uye_adi=konular.konu_ekleyen where konu_baslik regexp ? and konu_durum=?");
...
if($v){
    ...
    echo "<div class='well'>Aradığınız konu bulunmuyor.</div>";
}
