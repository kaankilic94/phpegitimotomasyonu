...
<div class="container">
    <div class="row">
        <div class="col-md-18">
            <div class="box">
                <h2 class="intro-text text-center trhcep">COĞRAFYA VİDEO İZLE</h2>
                <hr>

                <?php
                $sorgu2=$veritabani->query("SELECT * FROM sosyalvideos");
                while ($run=$sorgu2->fetch_object()){
                    ...
                    ?>
                    <a href="sosyalvideoizle.php?sosyalvideo=<?php echo $video_url; ?>">
                        <div id="url">
                            <?php  echo $video_name;?>
                        </div>
                    </a>
