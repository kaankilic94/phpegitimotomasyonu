        ...
        <div class="col-md-18">
            <div class="box" id="bx">
                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
                        <div class="panel panel-default">
                            <div class="panel-heading" id="panel-h9"><p>Kubilay Görkemli</p></div>
                            <div class="panel-body">
                                <div class="col-md-4"> <img class="img-responsive" src="img/kubilay.png" alt=""/> </div>
                                <div class="col-md-4">
                                    <ol class="personelBilgi">
                                        <li><a target="_blank" class="btn btn-success btn-large">Kişisel Web Sitesi</a></li>
                                        <li><span class="inf">E-posta: kubilaygörkemli@gmail.com</li>
                                        <li><span class="inf">Telefon:</span></li>
                                        <li><span class="inf">Branş:</span> Coğrafya</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
                        <div class="panel panel-default">
                            <div class="panel-heading" id="panel-h9"><p>Kaan Kılıç</p></div>
                            <div class="panel-body">
                                <div class="col-md-4"> <img class="img-responsive" src="img/kaan.jpg" alt=""/> </div>
                                <div class="col-md-4">
                                    <ol class="personelBilgi">
                                        <li><a href="https://www.linkedin.com/in/kaan-k%C4%B1l%C4%B1%C3%A7-6457b7136?trk=hp-identity-name" target="_blank" class="btn btn-success btn-large">Kişisel Web Sitesi</a></li>
                                        <li><span class="inf">E-posta: kaan.kilic53@gmail.com</li>
                                        <li><span class="inf">Telefon:</span></li>
                                        <li><span class="inf">Branş:</span> Tarih</li>
                                    </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
                        <div class="panel panel-default">
                            <div class="panel-heading" id="panel-h10"><p>Ahmet Yılmaz</p></div>
                            <div class="panel-body">
                                <div class="col-md-4"> <img class="img-responsive" src="" alt=""/> </div>
                                <div class="col-md-4">
                                    <ol class="personelBilgi">
                                        <li><a target="_blank" class="btn btn-success btn-large">Kişisel Web Sitesi</a></li>
                                        <li><span class="inf">E-posta: ahmeyılmaz@gmail.com</li>
                                        <li><span class="inf">Telefon:</span></li>
                                        <li><span class="inf">Branş:</span> Matematik</li>
                                    </ol>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
                        <div class="panel panel-default">
                            <div class="panel-heading" id="panel-h11"><p>Ali Yıldırım</p></div>
                            <div class="panel-body">
                                <div class="col-md-4"> <img class="img-responsive" src="" alt=""/> </div>
                                <div class="col-md-4">
                                    <ol class="personelBilgi">
                                        <li><a  target="_blank" class="btn btn-success btn-large">Kişisel Web Sitesi</a></li>
                                        <li><span class="inf">E-posta: aliyildirim@gmail.com</li>
                                        <li><span class="inf">Telefon:</span></li>
                                        <li><span class="inf">Branş:</span>Fen Bilimleri</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
