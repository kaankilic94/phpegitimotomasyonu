    ...
    <div class="row">
        <div class="col-md-18">
            <div class="box" id="bx">
                ...
                <h2 class="intro-text text-center trhcep">MATEMATİK SORUSU SİL</h2>
                <hr>
                ...
                {
                    $sorg = $baglanma->query("SELECT * FROM test WHERE tid");
                    ...
                    while($row = $sorg->fetch_object())
                    {
                        ...
                        <form action="testsilvt.php" method="post">
                            ...
                            <div class="form-group">
                                <label><input type="checkbox" value="<?php echo $row->tid; ?>" name="tid">Testin silinmesi icin kutucuğu işaretleyiniz.</label>
                            </div>
