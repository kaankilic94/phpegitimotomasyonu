<?php
$v=$db->prepare("select * from uyeler where uye_rutbe=? or uye_rutbe=? order by uye_id desc");
$v->execute(array(0,1));
            ...
            if($x){
                ...
                foreach ($k as $m){
                    ...
                    <tr>
                        ...
                        <td><?php
                            if($m["uye_rutbe"]==1){
                                echo "<span   style='color: black'><b>Moderatör</b></span>";
                            }else{
                        ...
                        <td> <span><a href="../administrator/?do=uye_duzenle&id=<?php echo $m["uye_id"]; ?>">düzenle</a></span> </td>

                        <td>
                            <form style="display: inline;" action="../administrator/?do=uye_sil" method="post">
