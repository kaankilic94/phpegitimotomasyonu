...
if($_SESSION){
    ...
    if($_SESSION["rutbe"]==2){
        ...
        <nav id="mainNav" class="navbar static-top navbar-toggleable-md navbar-inverse bg-inverse">
            ...
            <div class="collapse navbar-collapse" id="navbarExample">
                <ul class="sidebar-nav navbar-nav">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="?do=ogretmenler"><i class="fa fa-user"></i>Öğretmenler(Koü Eğitim)</a>
                    </li>
                    <li class="nav-item">
        ...
        echo " <div style=\"margin: 15px;\" class=\"breadcrumb\">Yönetici yetkiniz olmadan bu sayfaya ulaşamazsınız.</div>";
    }
