<div class="content-wrapper py-3">
    ...
    if (@$_POST["sil"]){
        ...
        if($toplu){
            ...
            header("refresh:2; url=../administrator/?do=uyeler");
        }else{
            echo "<div style=\"margin: 15px; \" class=\"breadcrumb\">Üyeleri silinmedi lütfen tekrardan deneyin</div>";
            header("refresh:2; url=../administrator/?do=uyeler");
        }
    }else{
        echo "<div style=\"margin: 15px; \" class=\"breadcrumb\">Üyeleri silmek için lütfen silmek istediğiniz üyenin kutucuğunu işaretleyin</div>";
        header("refresh:2; url=../administrator/?do=uyeler");
    }
    ?>
</div>