...
$sor=$vt->query("SELECT * FROM tarih");
...
$vt->query("INSERT INTO tarih(tid,soru,cevap1,cevap2,cevap3,cevap4,dogru) VALUES ('$j','$dsoru','$dcevapa','$dcevapb','$dcevapc','$dcevapd','$radyo')");

include "tariheklevtbasarili.php";
//$sonuc = $vt->query($sql);
